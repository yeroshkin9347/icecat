...
export const getDefaultListFilters = () => {
  return {
    Skip: 0,
    Take: 20,
  };
...
export const getDefaultTransformationSet = () => {
  return {
    name: null,
    transformations: [],
    taxonomyId: null,
...
export const getDefaultTransformation = () => {
  return {
    name: null,
...
export const isTemplateAction = (action) =>
    get(action, "discriminator") === "TemplateActionViewModel";

export const isActionExecutionConditionNone = (action) =>
    get(action, "discriminator") === "BuiltInActionViewModel" &&
    get(action, "actionExecutionCondition") === "None";
export const isActionExecutionConditionCurrentValueNull = (action) =>
    get(action, "actionExecutionCondition") === "IfCurrentValueIsNull";
export const isActionExecutionConditionCurrentValueNotNull = (action) =>
    get(action, "actionExecutionCondition") === "IfCurrentValueIsNotNull";
